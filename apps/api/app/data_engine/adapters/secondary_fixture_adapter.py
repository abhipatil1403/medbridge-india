...
class SecondaryFixtureAdapter(BaseSourceAdapter):
    @property
    def source_id(self) -> str:
        return "src_fixture_002"

    def fetch(self) -> str:
        """Reads the synthetic JSON fixture."""
        current_dir = os.path.dirname(__file__)
        fixture_path = os.path.join(current_dir, "..", "fixtures", "secondary_hospital_source.json")
    ...
    def normalize(self, parsed_item: Dict[str, Any], retrieved_at: str, raw_record_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "telephone": parsed_item.get("telephone", None),
            "totalBeds": parsed_item.get("totalBeds", None),
